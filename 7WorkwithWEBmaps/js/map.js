...
require([
        ...
        function (Map, arcgisUtils, Extent,
            FeatureLayer, Legend, BasemapGallery, 
...
// @formatter:on
        ...
        ready(function () {
            ...
            mapMain.on("layers-add-result", function () {
                dejo comentado este codigo de crador de leyenda aunque no se usará.
                var dijitLegend = new Legend({
                    map: mapMain,
                    arrangement: Legend.ALIGN_RIGHT
                }, "divLegend");
